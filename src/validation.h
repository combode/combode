 ...
 * @param[out]  dbp     The already known disk position of pblock, or NULL icbet yet stored.
 ...
 * - "rpc": get critical warnings, which should put the client in safe mode icben-empty
 ...
 * Fills hashRet with found hash, icbe nBlockHeight is specified - chainActive.Height() is used.
 */
