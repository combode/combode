 ...
 *
 *   // network
 *   CCombodeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CCombodeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCombodeNetwork(UniValue objIn)
    {
...
// // can be under: CombodeNetwork
// //   -- signature requirements : Key1(User)
// class CCombodeNetworkVariable : public CGovernanceObject
// {
// private:
