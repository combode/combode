...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CombodeNetwork") type = CombodeNetwork;
    if(strType == "CombodeNetworkVariable") type = CombodeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CombodeNetwork) s = "CombodeNetwork";
    if(type == CombodeNetworkVariable) s = "CombodeNetworkVariable";
