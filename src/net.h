...
public:
    ...
    // because it's used in many Combode-specific places (masternode, privatesend).
    ...
    // in case ocbe limit, it will always response 0
...
public:
    ...
    // The pong reply we're expecting, or 0 icbe pong expected.
    uint64_t nPingNonceSent;
    // Time (in usec) the last ping was sent, or 0 icbe ping was ever sent.
