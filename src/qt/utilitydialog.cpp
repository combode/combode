    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Combode Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Combode Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  combode-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Combode in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CBE, 0.1 CBE, 1 CBE and 10 CBE -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Combode Core is shutting down...") + "<br /><br />" +
