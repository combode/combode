    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Combode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Combode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and combode: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Combode Core"), this);
    aboutAction->setStatusTip(tr("Show information about Combode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Combode Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Combode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Combode addresses"));
    ...
    openAction->setStatusTip(tr("Open a combode: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Combode Core help message to get a list with possible Combode Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Combode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Combode network", "", count));
    } else {
...
{
    QString strTitle = tr("Combode Core"); // default title
    ...
    if (style & CClientUIInterface::MODAL) {
        // Check for buttons, use OK as default, icbene was supplied
