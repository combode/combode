...
//#define ENABLE_CBE_DEBUG
#ifdef ENABLE_CBE_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
 ...
 * Icbe translation slot is registered, nothing is returned, and simply return the input.
 */
...
{
    std::string s = strprintf("combode-%s", name);
