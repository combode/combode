...
#define BOOST_TEST_MODULE Combode Test Suite

#include "test_combode.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_combode_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
