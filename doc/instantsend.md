...
This mechanism has been integrated into Bitcore-Node-Combode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/combode-project/insight-api-combode#web-socket-api](https://github.com/combode-project/insight-api-combode#web-socket-api)
* API: [https://github.com/combode-project/insight-api-combode#instantsend-transactions](https://github.com/combode-project/insight-api-combode#instantsend-transactions)
...
By default, the Combode Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Combode Core daemon:
