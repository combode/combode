...
Only requiring some minor changes is combode.cpp.
...
Changes to combode.cpp
----------------------
combode.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
