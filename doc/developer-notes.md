...
Combode Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- DumpAddresses : Dumps IP addresses ocbedes to peers.dat.
...
However, in open source software such as Combode Core, where everyone uses
...
pay attention to for reviewers of Combode Core code.

General Combode Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Combode Core uses tinyformat, which is type safe. Leave them out to avoid confusion
